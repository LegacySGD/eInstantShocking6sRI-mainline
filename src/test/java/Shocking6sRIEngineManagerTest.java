...
public class Shocking6sRIEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(Shocking6sRIEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/Shocking6sRIIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/Shocking6sRIIW/InitOutcome.xml").getDocumentElement();
